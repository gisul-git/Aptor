"""
macOS installer build script using PyInstaller.

This script builds a standalone macOS application bundle from the agent code.
The bundle includes Python and all dependencies, so no Python installation
...
def main():
    """Main build process."""
    print("=" * 60)
    print("AI Competency Agent - macOS Build Script")
    print("=" * 60)
    ...
    if sys.platform != "darwin":
        print("WARNING: This script is designed for macOS. Building anyway...")
    ...
    print("Next step: Run build_pkg.sh to create .pkg installer")
    print("=" * 60)
