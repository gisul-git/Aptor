"""
Redis-based Test List Cache for Custom MCQ Service
...
- Cache key format: custom_mcq:tests:{user_id}:{page}:{limit}
...
CACHE_KEY_PREFIX_TESTS = "custom_mcq:tests:"
CACHE_KEY_PREFIX_DASHBOARD = "custom_mcq:dashboard:"
